$(function(){
    ...
    TweenMax.to($(".logo-lp"), 1,{"opacity" : "1", "delay" : "0.5", ease : Circ.easeOut});
    TweenMax.to($(".front"), 2,{"opacity" : "1", ease : Circ.easeOut});
    TweenMax.to($(".back"), 2,{"opacity" : "1", ease : Circ.easeOut});
